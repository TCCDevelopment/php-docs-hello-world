...
if ($_SERVER['REQUEST_METHOD'] !== 'POST' ||
    count($_POST) === 0 ||
    !key_exists("formkey-stacks_in_198", $_POST) ||
    $_POST["formkey-stacks_in_198"] !== "stacks_in_179") {
    http_response_code(500);
    echo "Error: Invalid request";
    exit;
}
unset($_POST["formkey-stacks_in_198"]);
require '../../rw_common/plugins/stacks/foundation-forms/foundation-autoload.php';

$templateFile = 'stacks_in_198_template.txt';
