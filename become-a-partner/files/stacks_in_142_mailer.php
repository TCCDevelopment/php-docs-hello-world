...
if ($_SERVER['REQUEST_METHOD'] !== 'POST' ||
    count($_POST) === 0 ||
    !key_exists("formkey-stacks_in_142", $_POST) ||
    $_POST["formkey-stacks_in_142"] !== "stacks_in_138") {
    http_response_code(500);
    echo "Error: Invalid request";
    exit;
}
unset($_POST["formkey-stacks_in_142"]);
require '../../rw_common/plugins/stacks/foundation-forms/foundation-autoload.php';

$templateFile = 'stacks_in_142_template.txt';
